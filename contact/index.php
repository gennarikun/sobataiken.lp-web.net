...
<body class="wp-singular page-template-default page page-id-29 custom-background wp-theme-lightning fa_v7_css bootstrap4 device-pc">
...
<!-- [ .breadSection ] --><div class="section breadSection"><div class="container"><div class="row"><ol class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList"><li id="panHome" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="../"><span itemprop="name"><i class="fa-solid fa-house"></i> HOME</span></a><meta itemprop="position" content="1"></li><li><span>お申込み・アクセス</span><meta itemprop="position" content="2"></li></ol></div></div></div><!-- [ /.breadSection ] -->
...
<h3 id="ate">注意事項</h3>
<p><b>トラブル防止のため、ご予約前に必ずキャンセルポリシーと注意事項をお読みください。</b><br>
<strong><i class="fa fa-arrow-circle-right" aria-hidden="true"></i><a class="alert-link" href="https://houtoutaiken.lp-web.net/rule/"> 注意事項を読む</a></strong></p>
</div>
</div>
...
<img decoding="async" src="https://upload.wikimedia.org/wikipedia/commons/4/41/LINE_logo.svg" alt="LINE Logo"><br>
LINEで問い合わせ<br>
</a></p>
<p>リンククリック後に表示される項目の回答をお送りください。24時間受け付けており返信は必ず致します。スムーズにご予約を希望されるお客様はぜひご利用ください。</p>
<h3 id="line"><strong>WhatsApp</strong>で予約</h3>
...
<p><a class="btn btn-primary btn-lg contact_bt" href="./"><span class="contact_bt_txt">お問い合わせもこちら </span><span class="contact_bt_subTxt">お気軽にご相談ください</span></a></p>
</div>
</section>
</div>
</div>
