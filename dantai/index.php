  ...
  <section class="lch-genre lch-genre--white" aria-labelledby="lch-genre-hoto">
    <div class="lch-genre-inner">
      <div class="lch-genre-head">
        ...
        <p class="lch-genre-note"><strong>4名様ごとに1つの鍋でご提供します。</strong>ご到着後、鍋に麺・お野菜・お肉を入れて、お客様ご自身で仕上げてお召し上がりいただきます（約10分）。4名様以下は個別盛りでのご提供も承ります。</p>
    ...
    <div class="lch-cond-bento">
      <div class="lch-cond-item">
        ...
        <div class="lch-cond-body">
          ...
          <ul>
            <li><strong>4 名様ごとに 1 つの鍋</strong>でご提供（鍋に麺・お野菜・お肉を入れてご自身で仕上げます／約10分）</li>
    ...
    <div class="lch-faq-list">
      ...
      <details>
        ...
        <div>
          ...
          <p>ほうとうは鍋をお持ちしてから約10分で仕上がります。焼肉は4名様ごとの卓上コンロで焼きながらお召し上がりいただきます。観光バスのご出発時刻が決まっている場合は、ご予約時にお知らせください。</p>
          <p>ほうとう体験・藍染体験など、体験メニューとの組み合わせも承っておりますのでご相談ください。</p>
        </div>
      </details>

      <details>
        <summary>ほうとうは1人ずつ提供されないのですか？</summary>
        <div>
          <p>4名様ごとに1つの鍋でご提供します。ご到着後、鍋に麺・お野菜・お肉を入れて、お客様ご自身で仕上げてお召し上がりいただきます（約10分）。</p>
          <p>4名様以下でのご利用や、ご事情のある方には個別盛りでのご提供も承りますので、ご予約時にお知らせください。</p>
        </div>
      </details>

      <details>
        <summary>同じ団体で複数のメニューを選べますか？</summary>
        <div>
          <p>はい。ほうとう・吉田のうどん・山梨ジビエ焼肉を組み合わせてご注文いただけます。</p>
          <p>ただしメニューごとに上限があり、吉田のうどんは15名様まで、焼肉は20名様までとなります。ご予約時に品目ごとの人数をお知らせください。</p>
        </div>
      </details>
